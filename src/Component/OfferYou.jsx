          ...
          <div className="row gy-4 text-center">
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div className="service-item position-relative" style={styles.serviceItem}>
                ...
                <p className='fs-6 fw-bold'>
                  نتميز في بلاك بيرد بتقديم كافة الحلول العصرية ومتابعة أحدث التطورات في عالم التسويق الرقمي والسوشيال ميديا، مع تقديم مقترحات لنمو أعمالك في كافة المجالات وتقديم خطة تسويقية متكاملة.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div className="service-item position-relative" style={styles.serviceItem}>
                ...
                <p className='fs-6 fw-bold'>
                  نمتلك في بلاك بيرد فريق متخصص في كافة الخدمات التسويقية متخصص في الحملات الاعلانية، الموشن جرافيك، إدارة صفحات السوشيال ميديا، كتابة المحتوى الرقمي وغيرها من الخدمات المتكاملة.
                </p>
              </div>
            </div>
